...
List<Product> products = [
  Product(
    ...
    price: "4900 CFA",
    imageUrl: "assets/creso1.png",
    isNew: true,
  ),
  Product(
    name: "SUNSPROTECTION Creme Masque Viasge",
    price: "3800 CFA",
    imageUrl: "assets/creso2.jpg",
    isNew: true,
  ),
  Product(
    name: "SOLAR PROTECTOR  Huile Protecteur Douceur",
    price: "3000 CFA",
    imageUrl: "assets/creso3.png",
  ),
  Product(
    name: "BYPHASSE Rétinol Crème Anti-rides Fermeté",
    price: "5 200 CFA",
    imageUrl: "assets/creso4.png",
    isNew: true,
  ),
  Product(
    name:
        "SUNSCREEN Une large gamme de creme, d'huile et de lotion pour un visage lumineux",
    price: "2 000 CFA",
    imageUrl: "assets/creso5.png",
    isNew: true,
  ),
];
