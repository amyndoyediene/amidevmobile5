  ...
  Widget _buildProductGrid(BuildContext context) {
    return Padding(
      ...
      child: GridView.count(
        ...
        children: [
          _buildProductItem(context, 'Homme', 'assets/inscri.png'),
          _buildProductItem(context, 'Femme', 'assets/amm.jpeg'),
          _buildProductItem(context, 'Enfant', 'assets/inscri.png'),
          _buildProductItem(context, 'Parfum', 'assets/amm.jpeg.png'),
          _buildProductItem(context, 'Cheveux', 'assets/inscri.png'),
          _buildProductItem(context, 'Marque', 'assets/amm.jpeg'),
